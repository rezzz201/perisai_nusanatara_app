...
class _BukuTamuState extends State<BukuTamu> {
  ...
  String noVisitor = 'no_visitor';
  String namaTamu='namaTamu';
  ...
  Future postUpload() async {
    ...
    var url = Uri.parse('http://192.168.1.16:5000/daftar-tamu');
    var request = http.MultipartRequest("POST", url);
    var multipartFile =
        http.MultipartFile("foto", stream, length, filename: 'x.jpg');

    request.files.add(multipartFile);
    request.fields['id_bukutamu'] = idbukuTamu;
    request.fields['no_visitor'] = noVisitor;
    request.fields['nama'] = namaTamu;
